...
class CustomUserManager(BaseUserManager):
       def create_user(self,email, password = None, **extra_fields):
              ...
              user = self.model(email = email, **extra_fields)# This creating a python objects in the memeory it puts the clean email and the extra feild into the user model Note: It hasn't touched the database yet.
